...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_INTENT_ID = 199;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 99;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        Intent ignorReminderIntent = new Intent(context, WaterReminderIntentService.class);
        ignorReminderIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
