...
public class TaskContract {
    ...
    public static final String PATH_TO_TASKS_DIRECTORY = "tasks";


    /* TaskEntry is an inner class that defines the contents of the task table */
    public static final class TaskEntry implements BaseColumns {

        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendEncodedPath(PATH_TO_TASKS_DIRECTORY).build();
